...
<img src="image/prototype.jpg" width="600" height="400" alt="시제품 테스트 모습">
<img src="image/core_kit.jpg" width="600" height="400" alt="실제 부착형 키트 모습">
...
아두이노 설정
    ...
    Arduino IDE에서 safety_echo_main.ino 파일을 엽니다.

    아두이노 우노 보드를 연결하고 코드를 업로드합니다.
